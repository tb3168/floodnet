...
# -*- coding: utf-8 -*-
"""
Created on Tue May  6 15:32:48 2025
...
def get_false_negative_df(false_neg_ids, ds):
    ...
    p = ggplot(false_neg_signal,aes(x="t_pct",y = "depth_raw_mm",group="uuid")) + geom_line(alpha=0.5)  + ylim(-100,false_neg_signal.depth_raw_mm.max()+15) + \
    labs(title="False Negatives for Feature Extraction & Classifier")
    p.show()
